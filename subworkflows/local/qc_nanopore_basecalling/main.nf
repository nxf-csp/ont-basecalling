/*
Сабворкфлоу с функционалом QC выходных данных бэйсколлинга прочтений Oxford Nanopore
*/
...
workflow QC_NANOPORE_BASECALLING {
    take:
    ubam
    ch_versions
    ch_multiqc_files
    ...
    ch_versions = ch_versions.mix(SEQUALI.out.versions)
